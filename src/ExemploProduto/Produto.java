...
public class Produto {
    ...
    public Produto(Integer codigo, String nomeDoProduto) {
        this.codigo = codigo;
        this.nomeDoProduto = nomeDoProduto;
    }

    public Produto(Integer codigo, String nomeDoProduto, Integer quantidade) {
        this.codigo = codigo;
        this.nomeDoProduto = nomeDoProduto;
        this.quantidade = quantidade;
    }

    public Produto(Integer codigo, String nomeDoProduto, Integer quantidade, String tipo, Double valorDoProduto) {
        this.codigo = codigo;
        this.nomeDoProduto = nomeDoProduto;
        this.quantidade = quantidade;
        this.tipo = tipo;
    ...
    public void iguais(Produto produto){
